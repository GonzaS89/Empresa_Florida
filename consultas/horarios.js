...
const horariosLvFloAl = [
    ...
    },
    {
        "nombre": "12:20",
        "salida": 12.2,
        "recorrido": "Fortín → Colonia 4 (Luisiana) (12:35)→ B° La Cancha → Talar → Alderetes → Autopista → Terminal"
    },
    {
        "nombre": "12:40",
        "salida": 12.4,
...
const horariosSFloAl = [
    ...
    },
    {
        "nombre": "20:55",
        "salida": 20.55,
        "recorrido": "Finca Mayo → Colonia 4 (Luisiana) → B° La Cancha → Talar → Alderetes → Autopista → Terminal"
    }
...
const horariosLvFloPo = [
    ...
    },
    {
        ...
        "recorrido2": "Fortín → Esquina Lastra → Paraiso → Posse → Esquina Llona → Cevil Pozo → Banda del Río Salí → Terminal"
    },
    // {
    //     "nombre": "18:55",
    //     "salida": 18.55,
...
const horariosLvSMAl = [
    ...
    // },
    {
        "nombre": "07:15",
        "salida": 7.15,
        "recorrido": "Terminal → Banda del Río Salí → Alderetes → Talar → Fonda → Colonia 4 (Luisiana) → Colonia 10 (Luisiana) → Colonia 4 (Florida) → Finca Mayo → La Marta" 
    },
    {
        "nombre": "08:00",
        "salida": 8,
    ...
    },
    {
        ...
        "recorrido2": "Terminal → Comisaria 11 → Autopista → Alderetes → Talar → Colonia 4 (Luisiana) → B° La Cancha → Colonia 4 (Florida)"
    },
    {
        "nombre": "16:50",
        "salida": 16.5,
    ...
    // },
    {
        "nombre": "20:30",
        "salida": 20.3,
        "recorrido": "Terminal → Banda del Río Salí → Alderetes → Talar → Esquina Lastra → Fortín → B° La Cancha → Colonia 4 (Luisiana)"
    },
    // {
    //     "nombre": "20:45",
    //     "salida": 20.45,
...
const horariosSSMAl = [
    ...
    // },
    {
        "nombre": "12:20",
        "salida": 12.2,
        "recorrido": "Terminal → Catalinas Park → Autopista → Alderetes → Talar → Fortín → B° La Cancha → Colonia 4 (Luisiana)"
    },
    // {
    //     "nombre": "13:15",
    //     "salida": 13.15,
    ...
    // },
    {
        "nombre": "13:30",
        "salida": 13.3,
        "recorrido": "Terminal → Banda del Río Salí → Alderetes → Talar → Colonia 4 (Luisiana) → La Marta"
    },
    {
        "nombre": "14:00",
        "salida": 14,
    ...
    // },
    {
        "nombre": "16:50",
        "salida": 16.5,
        "recorrido": "Terminal → Banda del Río Salí → Alderetes → Cochuchal → Esquina Lastra → Colonia 4 (Luisiana) → Fortín"
    },
    // {
    //     "nombre": "17:40",
    //     "salida": 17.4,
...
const horariosLvSMPo = [
    ...
    },
    {
      "nombre": "10:20",
      "salida": 10.2,
      "recorrido": "Terminal → Banda del Río Salí → Cevil Pozo → Esquina Llona → Posse → Paraíso → Esquina Longo"
  },
    {
        "nombre": "10:30",
        "salida": 10.3,
    ...
    // },
    {
    ...
    },
     {
        "nombre": "12:20",
        "salida": 12.2,
        "recorrido": "Terminal → Banda del Río Salí → Cevil Pozo → Fila del medio → Posse → Bosque → Paraíso → Fortín",
        // "recorrido": "Terminal → Banda del Río Salí → Cevil Pozo → Esquina Llona → Posse → Paraíso → Esquina Lastra → Fortín"
    },
    {
        "nombre": "12:30",
    ...
    },
    {
        "nombre": "21:20",
        "salida": 21.2,
        "recorrido": "Terminal → Banda del Río Salí → Cevil Pozo → Esquina Llona → Bosque → Posse → Paraíso → B° La Cancha → Colonia 4 (Luisiana)"
    },
    {
        "nombre": "21:30",
        "salida": 21.3,
...
const horariosSSMPo = [
    ...
    },
    {
        "nombre": "15:30",
        "salida": 15.3,
        "recorrido": "Terminal → Banda del Río Salí → Cevil Pozo → Fila del medio → Bosque → Posse → Paraíso → B° La Cancha → Colonia 4 (Luisiana)"
    },
    {
        "nombre": "16:00",
        "salida": 16,
...
const posseTerminalLaV = [
    ...
    },
    {
        "nombre": "07:40",
        "salida": 7.40,
        "recorrido": "Bosque → Fila del medio → Esquina Llona → Cevil Pozo → Banda del Río Salí → Terminal"
    },
    // {
    //     "nombre": "07:40",
    //     "salida": 7.4,
...
const ralosTerminalD = [
    ...
    },
    {
        "nombre": "12:15",
        "salida": 12.15,
        "recorrido": "Cruce → Finca Mayo → Los Ralos (trasbordo)"
    },
    {
        "nombre": "13:10",
        "salida": 13.1,
...
const terminalRalosLaV = [
    ...
    },
    {
        "nombre": "06:30",
        "salida": 6.3,
        "recorrido": "Terminal → Banda del Río Salí → Cevil Pozo → Esquina Llona → Los Ralos → Lolita Norte"
    },
    {
        "nombre": "07:00",
        "salida": 7,
...
const lasCejasTerminalLaV = [
    ...
    },
    {
        "nombre": "05:20",
        "salida": 5.2,
        "recorrido": "Paso de la patria → Las Cejas → Lolita Sur → Los Ralos → Esquina Llona → Cevil Pozo → Banda del Río Salí → Terminal"
    },
    // {
    //     "nombre": "06:35",
    //     "salida": 6.35,
